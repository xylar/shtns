...
static PyMethodDef SwigMethods[] = {
	 ...
	 { (char *)"new_sht", (PyCFunction) _wrap_new_sht, METH_VARARGS | METH_KEYWORDS, (char *)"new_sht(int lmax, int mmax, int mres=1, int norm=sht_orthonormal, int nthreads=0) -> sht"},
