...
# {
X	complex double reo[NLAT];	// symmetric (even) and anti-symmetric (odd) parts, interleaved.
V	complex double teo[NLAT], peo[NLAT];	// theta and phi even and odd parts
...
V			Sl[l] = 0.0;	Sl[l+1] = 0.0;		// Qlm[LiM(l,im)] = 0.0;	Qlm[LiM(l+1,im)] = 0.0;
